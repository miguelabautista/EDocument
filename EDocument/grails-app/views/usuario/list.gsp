			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="cedula_rif" title="${message(code: 'usuario.cedula_rif.label', default: 'Cedularif')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "cedula_rif")}</td>
